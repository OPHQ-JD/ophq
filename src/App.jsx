...
const liveRolloutChecklist = [
  { id: "schema", title: "Create cloud database tables", status: "Next", owner: "Backend", test: "Tables exist and local snapshot can map into cloud records." },
  { id: "auth-provider", title: "Connect real login provider", status: "Pending", owner: "Backend", test: "Jon/Operations, Sales and Staff profiles log in with correct role." },
  { id: "rls", title: "Enforce backend permissions", status: "Pending", owner: "Backend", test: "Sales cannot create jobs/POs; Staff cannot see pricing." },
  { id: "numbering", title: "Move numbering to backend", status: "Next", owner: "Backend", test: "Two users cannot reserve the same QU/JD/DN/ENQ/PO number." },
  { id: "documents", title: "Store generated PDFs", status: "Pending", owner: "Backend", test: "Quote, job sheet, enquiry, PO and delivery PDFs save against the record." },
  { id: "staging", title: "Deploy staging app", status: "Pending", owner: "Release", test: "Full quote-to-delivery workflow passes with test data." },
  { id: "production", title: "Production launch", status: "Pending", owner: "Release", test: "Backup taken, rollback available, team logins tested." },
];

const preLaunchWorkflowChecklist = [
  { id: "backup-before-test", area: "Backup", check: "Export a local OPHQ backup before testing.", pass: "Backup JSON downloads and can be previewed by Import backup." },
  { id: "quote-create", area: "Quotes", check: "Create a steel quote with material, holes/extras, VAT and markup.", pass: "Quote total, VAT, weight and production hours look correct." },
  { id: "quote-approval", area: "Quote Approvals", check: "Send quote for approval, approve lead time, mark sent, mark accepted.", pass: "Quote moves through statuses without duplicate records." },
  { id: "job-create", area: "Jobs", check: "Create job from accepted quote.", pass: "JD number links to quote number and job appears in planner/job register." },
  { id: "planner", area: "Planner", check: "Update stage progression including weekend date use.", pass: "Current stage, staff allocation, delivery note trigger and calendar remain correct." },
  { id: "purchasing", area: "Purchasing", check: "Create supplier enquiry, send, receive quote, raise PO, mark sent/received.", pass: "Only selected PO opens/updates and stock is created with PO traceability." },
  { id: "stock", area: "Stock", check: "Allocate required length from ordered/full stock and scrap an offcut.", pass: "Allocated job length and remaining available length are shown correctly." },
  { id: "delivery", area: "Delivery", check: "Raise delivery note, sign it, confirm job leaves delivery calendar.", pass: "Signed delivery note is retained and job becomes ready for invoice/Xero." },
  { id: "permissions", area: "Roles", check: "Check Operations, Sales and Staff role views.", pass: "Sales cannot access jobs/POs; Staff cannot see pricing/admin controls." },
...
const backendHandoverSpec = [
  { area: "Domain", requirement: "Use ophq.ai for the production app.", decisionNeeded: "Confirm whether staging should use staging.ophq.ai or a private preview URL." },
  { area: "Hosting", requirement: "Deploy the React app to a managed host with HTTPS, environment variables and rollback support.", decisionNeeded: "Choose Vercel, Netlify, Cloudflare Pages or equivalent." },
  { area: "Database", requirement: "Move OPHQ records from browser local storage into a cloud database using the table plan below.", decisionNeeded: "Choose Supabase/Postgres, Firebase, or another managed database." },
  { area: "Auth", requirement: "Replace role switch with real logins for Operations, Sales and Staff.", decisionNeeded: "Choose auth provider and provide first user email list." },
  ...
  { area: "Backups", requirement: "Automatic scheduled database backups plus manual backup before every production release.", decisionNeeded: "Confirm retention period, suggested minimum 30 days." },
  ...
  { area: "Go-live blocker", requirement: "Do not use as the live company system while storageMode is local.", decisionNeeded: "Switch to cloud-api only after staging test passes." },
];
